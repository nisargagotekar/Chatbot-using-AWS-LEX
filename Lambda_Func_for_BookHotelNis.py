...
def generate_hotel_price(location, nights, room_type):
    ...
    room_types = ['queen', 'king', 'deluxe','suite','single bedded','double bedded]
    cost_of_living = 0
...
def isvalid_city(city):
    valid_cities = ['mumbai', 'pune', 'nashik', 'new york','chicago','seattle','san francis']
...
#reference taken from aws lambda function.